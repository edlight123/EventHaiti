      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-gray-600">Avg Ticket Price</div>
                <div className="text-3xl font-bold text-gray-900 mt-2">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-gray-900">{allEvents.length}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Upcoming Events</span>
                <span className="text-2xl font-bold text-green-600">{upcomingEvents}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Past Events</span>
                <span className="text-2xl font-bold text-gray-500">{pastEvents}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Events (Last 6 Months)</span>
                <span className="text-2xl font-bold text-teal-600">{recentEvents.length}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-purple-600">{totalOrganizers}</span>
              </div>
              <div className="flex items-center justify-between">
        ...
        {/* Additional Info */}
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl border-2 border-teal-200 p-8 text-center">
          <h3 className="text-2xl font-bold text-teal-900 mb-2">Platform Health</h3>
          <p className="text-teal-700 mb-4">
            Your event platform is growing! Keep monitoring these metrics to ensure success.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            <div className="bg-white rounded-lg p-4">
              <div className="text-xs text-gray-600">Events/Organizer</div>
              <div className="text-xl font-bold text-gray-900 mt-1">
                {totalOrganizers > 0 ? (allEvents.length / totalOrganizers).toFixed(1) : '0'}
              </div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-xs text-gray-600">Tickets/Event</div>
              <div className="text-xl font-bold text-gray-900 mt-1">
                {allEvents.length > 0 ? (allTickets.length / allEvents.length).toFixed(1) : '0'}
              </div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-xs text-gray-600">Revenue/Event</div>
              <div className="text-xl font-bold text-gray-900 mt-1">
                ${allEvents.length > 0 ? (totalRevenue / allEvents.length).toFixed(0) : '0'}
              </div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-xs text-gray-600">Revenue/Ticket</div>
              <div className="text-xl font-bold text-gray-900 mt-1">
