...
export default function CreateTestDataPage() {
  ...
  const testEvents = [
    ...
    },
    {
      ...
      currency: 'HTG',
      total_tickets: 1000,
      banner_url: 'https://images.unsplash.com/photo-1511735111819-9a3f7709049c?w=800',
      is_virtual: false,
      is_featured: true,
      is_published: true
    },
    ...
    },
    {
      ...
      currency: 'HTG',
      total_tickets: 40,
      banner_url: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800',
      is_virtual: false,
      is_featured: false,
      is_published: true
    },
    {
      ...
      currency: 'HTG',
      total_tickets: 2000,
      banner_url: 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?w=800',
      is_virtual: false,
      is_featured: true,
      is_published: true
    },
    {
      ...
      currency: 'HTG',
      total_tickets: 300,
      banner_url: 'https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?w=800',
      is_virtual: false,
      is_featured: true,
      is_published: true
    },
    {
      ...
      currency: 'HTG',
      total_tickets: 500,
      banner_url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800',
      is_virtual: true,
      is_featured: false,
      is_published: true
    }
