      ...
      <div className="max-w-7xl mx-auto px-0 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
              ...
              <div className="space-y-2.5">
                ...
                <div>
                  ...
                  <div className="space-y-1.5">
                    <div>
                      <p className="text-[15px] text-gray-700">{event.address || 'Address not specified'}</p>
            ...
            <div className="hidden md:block sticky top-8 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              <div className="mb-6">
                {isFree ? (
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">No ticket required</p>
                  </div>
                ) : (
                  <div>
              ...
              {isSoldOut ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600 mt-2">This event has reached capacity</p>
                </div>
              ) : (
                <>
                  {user ? (
                    ...
                    <>
                      ...
                      <p className="text-xs text-gray-500 text-center mt-3">Create an account to purchase tickets</p>
                    </>
                  )}
                </>
              )}
              ...
              {ticketsRemaining !== null && ticketsRemaining > 0 && (
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  {selloutSoon && (
                    <p className="text-xs text-orange-600 font-medium mt-2">⚡ Almost sold out!</p>
                  )}
                </div>
              )}
            </div>
        ...
        {relatedEvents?.length > 0 && (
          <div className="mt-12 px-4 md:px-0">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Similar Events</h2>
