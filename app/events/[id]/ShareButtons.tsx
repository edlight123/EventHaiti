...
export default function ShareButtons({ eventId, eventTitle }: ShareButtonsProps) {
  ...
  const handleShareTwitter = () => {
    ...
    const twitterUrl = `https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(eventUrl)}`
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mt-6">
      ...
      <div className="grid grid-cols-2 gap-2 mb-2">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 hover:opacity-90 text-white py-2 px-3 rounded-lg text-sm font-medium transition-opacity"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-3 rounded-lg text-sm font-medium transition-colors border border-gray-300"
      >
        📋 Copy Event Link
      </button>
    </div>
