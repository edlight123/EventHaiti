    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-8">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                ...
                <span className="text-gray-900">{ticket.event.venue}, {ticket.event.city}</span>
              </div>

              <div className="flex justify-between items-center pb-4 border-b border-gray-200">
                <span className="text-sm font-medium text-gray-600">Amount Paid</span>
                <span className="text-lg font-bold text-gray-900">${ticket.price_paid.toFixed(2)}</span>
              </div>
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-200">
              <div className="flex items-center justify-center h-48 bg-white rounded-xl border-2 border-dashed border-gray-300">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Show this at the entrance</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/tickets"
            className="px-8 py-3 rounded-full bg-orange-600 text-white font-semibold hover:bg-orange-700 transition text-center"
          >
            View My Tickets
          </Link>
          <Link
            href="/"
            className="px-8 py-3 rounded-full border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 transition text-center"
          >
            Find More Events
          </Link>
        </div>
