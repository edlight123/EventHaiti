        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          {wasRejected && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8">
              <h3 className="font-semibold text-red-900 mb-2">Previous Application Rejected</h3>
              <p className="text-sm text-red-800 mb-2">{existingRequest.admin_notes || 'Please review your documents and resubmit.'}</p>
            </div>
          )}
