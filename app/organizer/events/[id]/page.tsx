          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0">
              <Link
                ...
                className="flex-shrink-0 px-3 md:px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium text-[13px] md:text-sm flex items-center gap-1.5 md:gap-2 whitespace-nowrap"
              >
              ...
              <a
                ...
                download
                className="flex-shrink-0 px-3 md:px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium text-[13px] md:text-sm flex items-center gap-1.5 md:gap-2 whitespace-nowrap"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
