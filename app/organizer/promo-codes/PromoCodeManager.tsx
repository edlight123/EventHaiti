...
export default function PromoCodeManager({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Create Form */}
      {showForm && (
        <form onSubmit={handleCreate} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="mt-6 flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 rounded-lg bg-orange-600 text-white font-semibold hover:bg-orange-700 transition disabled:opacity-50"
            >
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
        ...
        {promoCodes.length === 0 ? (
          <div className="p-12 text-center">
            <p className="text-gray-600">No promo codes yet. Create one to get started!</p>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <span className="text-xl font-bold text-gray-900 font-mono">{promo.code}</span>
                      {!promo.is_active && (
