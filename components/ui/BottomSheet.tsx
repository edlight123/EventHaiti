...
export default function BottomSheet({
  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-2xl z-[101] max-h-[90vh] flex flex-col transition-transform duration-300 md:hidden"
      ...
      {isOpen && (
        <div className="hidden md:flex fixed inset-0 z-[100] items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col z-[101]">
            {/* Desktop Header */}
            {(title || showCloseButton) && (
