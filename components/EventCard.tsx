...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    <Link href={`/events/${event.id}`} className="group">
      <div className="bg-white rounded-2xl shadow-soft hover:shadow-hard transition-all duration-300 overflow-hidden border border-gray-100 group-hover:-translate-y-2 group-hover:border-brand-200 relative">
        ...
        <div className="p-5">
          ...
          <div className="space-y-2.5 mb-4">
            <div className="flex items-center text-sm text-gray-700">
              <div className="w-8 h-8 rounded-lg bg-accent-50 flex items-center justify-center mr-2.5 flex-shrink-0">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100">
            <div>
              ...
              {isFree ? (
                <p className="text-2xl font-bold bg-gradient-to-r from-success-600 to-success-700 bg-clip-text text-transparent">FREE</p>
              ) : (
            ...
            {!isSoldOut && (
              <div className="text-right">
                <p className="text-xs text-gray-500 mb-0.5 font-medium">Available</p>
                <p className={`text-sm font-bold ${selloutSoon ? 'text-warning-600' : 'text-brand-700'}`}>
