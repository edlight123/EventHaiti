    ...
    switch (status) {
      case 'not-setup':
        return {
          ...
          description: 'Connect your bank account to start receiving payments',
      ...
      case 'setup':
        return {
          ...
          title: 'Payouts Ready',
          description: 'Your payout method is configured and ready',
      ...
      case 'pending':
        return {
          ...
          description: 'We are reviewing your payout information',
      ...
      case 'active':
        return {
          ...
          description: 'Earnings are being processed automatically',
    ...
    <div className="bg-white rounded-2xl shadow-soft border border-gray-100 p-6">
      ...
      {status !== 'not-setup' && (
        <p className="text-xs text-gray-500 text-center mt-3">
          Payouts typically processed within 2-5 business days
        </p>
      )}
    </div>
  )
